# YouTube and Practice Links

This file contains the links for each lesson video and its corresponding online practice.

| Lesson | Title | Responsible | YouTube Link | Status |
|---|---|---|---|---|
| Lesson 1 | What is programming and Java? | Anghelo Faustino | Pending | Pending |
| Lesson 2 | Variables and data types | Anghelo Faustino | Pending | Pending |
...
- All YouTube videos must be uploaded as unlisted.
- All practice links should use an online Java editor, preferably OnlineGDB.
- If a direct practice link is not available, use the general OnlineGDB Java Compiler link and indicate the corresponding starter file from the repository.

## Main online editor

OnlineGDB Java Compiler: [https://www.onlinegdb.com/online_java_compiler](https://www.onlinegdb.com/online_java_compiler)
